...
nav.addEventListener('keydown', e => {
	document.getElementById("themecolor").setAttribute("content", "red");
...
window.addEventListener('scroll', function () {
	...
	if (scrollpos >= 50) {
		document.getElementById("invertedlogo").style.display = "none";
		document.getElementById("regularlogo").style.display = "block";
		add_class_on_scroll()
		...
		document.getElementById("menuicon").classList.add("fade-in")
	}
	else { 
		document.getElementById("regularlogo").style.display = "none";
		document.getElementById("invertedlogo").style.display = "block";
		...
		document.getElementById("menuicon").classList.remove("fade-in")
	}
